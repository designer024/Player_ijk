...
public class TextureRenderView extends TextureView implements com.leapsy.widget_media_lib.IRenderView {
    private static final String TAG = "TextureRenderView";
    private com.leapsy.widget_media_lib.MeasureHelper mMeasureHelper;
    ...
    private void initView(Context context) {
        mMeasureHelper = new com.leapsy.widget_media_lib.MeasureHelper(this);
    ...
    private static final class InternalSurfaceHolder implements ISurfaceHolder {
        ...
        @NonNull
        @Override
        public com.leapsy.widget_media_lib.IRenderView getRenderView() {
            return mTextureView;
        }
